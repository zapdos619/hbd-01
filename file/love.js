(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("Birthday Queen !", 28, 20);
        ...
        clear: function() {
            ...
            // Increase width and height clearing to cover larger text area:
            ctx.clearRect(point.x - w * 5, point.y - h * 5, 10 * w, 10 * h);
        },


        hover: function(x, y) {
            const center = this.cirle.point;
            const scale = this.cirle.scale;
            const radius = this.cirle.radius * scale * 4; // Adjust multiplier as needed
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        ...
        const bloomColors = ['#FFD6FF', '#E7C6FF', '#C8B6FF', '#B8C0FF', '#BBD0FF', 'red', 'orange','green','purple']; // Soft pastels
         this.color = color || bloomColors[random(0, bloomColors.length - 1)];
